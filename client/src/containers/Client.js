  ...
  // const handleClose = () => {
   ...
   // }
    ...
    const handleOnClick = () => {
      ...
      // useEffect resolveu, chamar os clientes apenas uma vez quando carrega a página  \\ se necessário, buscar outra solução
      useEffect(() => {
        ...
        axios.get(`/api/clients`, {
          ...
          // aqui quando for pegar os usuários vou pegar pelo companyid \\
    ...
    const useStyles = makeStyles((theme) => ({
      ...
      // tirei o container, assim a página está se comportando de forma normal agora, trazendo grids amplos, aparentemente as classes não mudavam nada
    return (
          <div>
        ...
        <Button
            ...
            <div style={{ height: 250, width: '100%', float:'left' }}>
             ...
             <ChangeDialogClient open={changeDialogIsOpen} onClose={closeChangeDialog} _id={userId} companyId={props.companyId} name={clientName} surname={clientSurname} cellphone={clientCell} email={clientEmail} />
