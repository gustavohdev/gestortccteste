    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} noValidate>
                ...
                />
                <TextField className={classes.textFieldUp} variant="outlined" margin="normal" required id="name" label="Modelo" name="name" onChange={(e) => setModel(e.target.value)} />
                <TextField
                ...
                <Button style={{ margin: "3px" }} type="submit" variant="contained" color="primary" disabled={!validateForm()}>
                    Add
                </Button>
            </form>
