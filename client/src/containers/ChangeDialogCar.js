...
export default function ChangeDialogCar(props) {
  ...
  // talvez se fazer estilo a parte de cima de props e ai traz os dados lá, aí talvez dê certo
        ...
        <DialogContent>
          <DialogContentText>
            ...
            <TextField
                ...
                <Button style={{'margin':'3px'}} type='submit' fullWidth variant="contained" color="primary" disabled={!validateForm()} >Alterar</Button>
            </form>
        </DialogContent>
        <DialogActions>
