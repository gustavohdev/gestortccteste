    ...
    return (
        <div style={{ marginTop: "5px" }}>
            <form onSubmit={handleSubmit} noValidate>
                <TextField variant="outlined" margin="normal" required fullWidth id="name" label={label} name="name" autoComplete="name" autoFocus onChange={(e) => setName(e.target.value)} />
                <Button style={{ margin: "3px" }} disabled={label == ""} type="submit" variant="contained" color="primary" disabled={!validateForm()}>
                    Add
                </Button>
            </form>
